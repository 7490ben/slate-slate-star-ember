...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Djo7tkz-.mjs");
...
var manifest = {
	"7f5018cd7d140ba52226a5505c62235879146850f28aed0e44e8c828f078c64d": {
		functionName: "toggleSaved_createServerFn_handler",
		importer: () => import("./favorites-BbL1iT1B.mjs")
	},
	"8ea045c06ce03fa8c675e49c0b07b09545583c1aadb75e77c0ad28d144dddea7": {
		functionName: "listSaved_createServerFn_handler",
		importer: () => import("./favorites-BbL1iT1B.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CQ2SYJIV.mjs").then((n) => n.t),
