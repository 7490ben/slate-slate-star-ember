...
import { HackIntro } from "@/components/boot-intro";
import { Toaster } from "sonner";
import appCss from "../styles.css?url";

const APP_NAME = "7490 Nation";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "7490 Nation at 7490.org — cursed GIFs, hardest edits, Spider-Man, Ghost Rider, Batman, Simpsons, cats, and Ben.",
      },
    ...
    <html lang="en" className="antialiased" suppressHydrationWarning>
      ...
      <body className="min-h-dvh bg-bg text-fg">
        ...
        <AuthProvider>
          ...
          <Outlet />
          <SiteFooter />
          {!booted ? <HackIntro onDone={onDone} /> : null}
          <Toaster
            theme="dark"
            toastOptions={{
              className: "!bg-surface !text-fg !border-line !shadow-line",
            }}
          />
        </AuthProvider>
        <Scripts />
